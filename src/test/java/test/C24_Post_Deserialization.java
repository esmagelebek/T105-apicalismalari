   ...
   */
    ...
    public void post01(){
        ...
        Response response=given().spec(specHerokuapp).
                contentType(ContentType.JSON).when().body(reqBody).post("/{pp1}");
       ...
       "booking":{
        ...
        Assert.assertEquals(((Map)(((Map)(expData.get("booking"))) .get("bookingdates"))) .get("checkin") ,
                ((Map)(((Map)(expData.get("booking"))) .get("bookingdates"))) .get("checkin"));


        Assert.assertEquals(((Map)(((Map)(expData.get("booking"))) .get("bookingdates"))) .get("checkout") ,
                ((Map)(((Map)(expData.get("booking"))) .get("bookingdates"))) .get("checkout"));
